...
This is a typical example on how to use the STM32F2xx USB OTG Device peripheral where the STM32 MCU
...
@par Hardware and Software environment
  ...
  - This example runs on STM32F217xx/STM32F217xx devices.
