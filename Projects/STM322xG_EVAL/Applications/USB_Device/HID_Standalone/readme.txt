...
use USB device application based on the Humain Interface (HID) on the STM32F2xx devices.

This is a typical example on how to use the STM32F2xx USB OTG Device peripheral where the STM32 MCU is
