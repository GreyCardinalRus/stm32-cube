...
USB host application based on the Humain Interface Class (HID) on the STM32F2xx devices.

This is a typical example on how to use the STM32F2xx USB OTG Host peripheral to interact with an USB 
