/**
  ...
  * @version V1.1.0
  * @date    13-March-2014
  * @brief   Description of the STM32F2xx LCD Paint example.
  ******************************************************************************
  *
...
@par Directory contents
    ...
    - Display/LCD_Paint/Inc/stm32f2xx_it.h              Header for stm32f2xx_it.c
    - Display/LCD_Paint/Inc/stm32f2xx_conf.h            library configuration file 
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM322xG-EVAL RevC evaluation board 
